...
function makeComputerMove() {
    ...
    // Determine delay based on whether it's the first move or a winning move
    let delay;
    if (moves === 0) {
        delay = getRandomDelay(400, 800); // Quick response for the first move
    } else if (moves >= 3 && myGrid.getFirstWithTwoInARow(computer) !== false) {
        delay = getRandomDelay(600, 1000); // Quick response if there's a winning move
    } else {
